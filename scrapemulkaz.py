...
def scrap_data(driver,surl):
    ...
    if 'vasitəçi' in adi:
        ...
        if 'Torpaq' in Kategoriya or 'Qaraj' in Kategoriya:
            ...
            try:
                Rayon=soup.select_one('#content > div.newsContentPage > div.col-md-4 > b:nth-child(8)').text+', '
                +soup.select_one('#content > div.newsContentPage > div.col-md-4 > b:nth-child(9)').text+', '
                +soup.select_one('#content > div.newsContentPage > div.col-md-4 > b:nth-child(10)').text+', '
                +soup.select_one('#content > div.newsContentPage > div.col-md-4 > br:nth-child(12)').text
            except:
                print('Yerleshme1 ex')
        else:
            try:
